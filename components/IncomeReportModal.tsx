  ...
  return (
    <div className="fixed inset-0 left-0 md:left-72 z-[100] flex items-center justify-center pointer-events-auto bg-gray-50 dark:bg-[#0d0d0d]">
      <div className="w-full h-full flex flex-col relative z-10 animate-fade-in overflow-hidden">
        ...
        {/* Header */}
        <div className="px-4 md:px-6 py-4 flex justify-between items-center bg-white/80 dark:bg-[#0d0d0d]/85 backdrop-blur-xl sticky top-0 z-20 border-b border-gray-200 dark:border-white/5">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8 w-full pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                             <div className="bg-amber-500 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 text-white relative overflow-hidden shadow-xl shadow-amber-500/20">
                             ...
                             <div className="bg-white dark:bg-[#1c1c1e] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 border border-gray-200 dark:border-white/5 shadow-xl flex flex-col justify-center">
                        ...
                        {/* Chart Section */}
                        <div className="bg-white dark:bg-[#1c1c1e] rounded-[2rem] md:rounded-[2.5rem] p-4 md:p-8 border border-gray-200 dark:border-white/5 shadow-xl flex-1 min-h-[350px]">
                            ...
                            <div className="w-full h-[300px] -ml-2">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={stats.history} margin={{ top: 10, right: 0, left: -20, bottom: 0 }}>
                                        ...
                                        <XAxis dataKey="name" tick={{ fill: '#9ca3af', fontSize: 10, fontWeight: 700 }} axisLine={false} tickLine={false} dy={10} />
                                        <Tooltip 
                                        ...
                                        <Bar 
                                            ...
                                            radius={[6, 6, 6, 6]} 
                                            barSize={window.innerWidth < 768 ? 24 : 32}
                        ...
                        <div className="bg-white dark:bg-[#1c1c1e] rounded-[2rem] md:rounded-[2.5rem] p-6 border border-gray-200 dark:border-white/5 shadow-xl flex-1 flex flex-col">
                             ...
                             <div className="flex-1 overflow-y-auto custom-scrollbar space-y-4 pr-1">
                                 {stats.topPayers.map((payer, idx) => (
                                     <div 
                                        key={payer.ticker} 
                                        className="bg-gray-50 dark:bg-[#2c2c2e]/40 p-4 md:p-5 rounded-2xl border border-gray-100 dark:border-white/5 flex items-center justify-between shadow-sm transition-transform hover:scale-[1.02]"
                                     >
                                         <div className="flex items-center gap-3 md:gap-4 flex-1">
                                             <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl flex items-center justify-center font-bold text-xs md:text-sm text-white shadow-md" style={{ backgroundColor: payer.color }}>
                                                 {payer.ticker.substring(0,4)}
                                             </div>
                                             <div className="flex-1">
                                                 <div className="flex justify-between items-baseline mb-1">
                                                     <span className="text-gray-900 dark:text-white font-bold text-sm md:text-base">{payer.ticker}</span>
                                                 </div>
                                                 <div className="flex items-center gap-2">
                                                     <div className="h-1.5 md:h-2 w-16 md:w-20 bg-gray-200 dark:bg-[#0d0d0d] rounded-full overflow-hidden">
