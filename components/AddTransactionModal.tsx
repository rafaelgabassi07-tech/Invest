...
// Simple Icons for local use inside this component
...
// Helper to parse "23 Dez 2025" back to "2025-12-23"
...
export const AddTransactionModal: React.FC<AddTransactionModalProps> = ({ onClose, onSave, initialTransaction }) => {
  ...
  useEffect(() => {
    if (initialTransaction) {
        ...
        // Try to infer type (naive check, usually data would have this)
