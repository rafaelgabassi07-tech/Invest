            ...
            <div className="max-w-7xl mx-auto px-6 py-8 w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white dark:bg-[#1c1c1e] rounded-[2.5rem] p-8 border border-gray-200 dark:border-white/5 shadow-xl relative overflow-hidden animate-slide-up">
                            ...
                            <div className="relative z-10 text-center py-10">
                                ...
                                <h2 className="text-7xl font-bold text-gray-900 dark:text-white tracking-tighter mb-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 relative z-10 mt-8">
                                <div className="bg-gray-50 dark:bg-[#2c2c2e]/50 rounded-3xl p-6 border border-gray-100 dark:border-white/5 text-center">
                                    ...
                                    <p className="text-indigo-500 font-bold text-2xl">+{accumulatedNominal.toFixed(2)}%</p>
                                </div>
                                <div className="bg-gray-50 dark:bg-[#2c2c2e]/50 rounded-3xl p-6 border border-gray-100 dark:border-white/5 text-center">
                                    <p className="text-gray-400 text-[10px] font-bold uppercase mb-2">Inflação (IPCA)</p>
                                    <p className="text-rose-500 font-bold text-2xl">-{accumulatedInflation.toFixed(2)}%</p>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Right Column: Chart */}
                    <div className="bg-white dark:bg-[#1c1c1e] rounded-[2.5rem] p-8 border border-gray-200 dark:border-white/5 shadow-lg flex flex-col h-[500px] lg:h-auto animate-slide-up" style={{ animationDelay: '100ms' }}>
